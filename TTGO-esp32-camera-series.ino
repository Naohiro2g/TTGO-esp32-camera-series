...
#include "esp_wifi.h"
#include <ESPmDNS.h>   // zeroconf or bonjour 
/***************************************
 *  Board select
 **************************************/
...
#define AVAHI
#ifdef AVAHI
#define AVAHI_HOST "TTGO-cam" // accessible as TTGO-cam.local
#endif
...
int yOfset1, yOfset2, yOfset3;
    ...
    display->drawString( 64 + x, yOfset1 + y, "Camera Ready! Use");
    display->drawString(64 + x, yOfset2 + y, hostDisplay );
    display->drawString(64 + x, yOfset3 + y, "to connect");
#endif
}
